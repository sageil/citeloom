...
export const runtimeSettingDefinitions: readonly RuntimeSettingDefinition[] = [
  ...
  numberSetting("retrievalCandidates", "Retrieval", "Candidate count", "How many semantic and keyword matches CiteLoom considers before combining rankings.", 1, 200, 1),
  numberSetting("retrievalVariantConcurrency", "Retrieval", "Query variant concurrency", "How many versions of a question CiteLoom searches at the same time.", 1, 16, 1),
  numberSetting("queryExpansions", "Retrieval", "Query expansions", "How many alternative searches the AI writes for each question.", 0, 4, 1),
  numberSetting("queryExpansionTemperature", "Retrieval", "Query expansion temperature", "Sampling temperature used when the model writes retrieval query expansions.", 0, 2, 0.01),
  numberSetting("answerTemperature", "Retrieval", "Answer temperature", "Sampling temperature used when the model writes a grounded answer.", 0, 2, 0.01),
  selectSetting("generationSeedMode", "Retrieval", "Generation seed mode", "Choose stable request-derived seeds for reproducible runs or provider-selected randomness.", [
    { label: "Stable", value: "stable" },
    { label: "Random", value: "random" },
  ]),
  numberSetting("denseWeight", "Retrieval", "Dense signal weight", "How much semantic similarity influences the combined ranking.", 0.01, 100, 0.01),
  numberSetting("lexicalWeight", "Retrieval", "Lexical signal weight", "How much keyword matching influences the combined ranking.", 0.01, 100, 0.01),
  numberSetting("originalQueryWeight", "Retrieval", "Original question weight", "How much the user's original question influences the combined ranking.", 0.01, 100, 0.01),
  numberSetting("expansionQueryWeight", "Retrieval", "Expansion weight", "How much the first AI-written search variation influences the combined ranking.", 0.01, 100, 0.01),
  numberSetting("expansionDecay", "Retrieval", "Expansion decay", "How quickly later AI-written search variations lose influence.", 0.01, 1, 0.01),
  numberSetting("rrfK", "Retrieval", "RRF smoothing constant", "How much small rank differences matter when search lists are combined.", 1, 1_000, 1),
...
export const runtimeSettingChangeExamples = {
  ...
  queryExpansionTimeoutSeconds: "Raise 900 when browser query expansion needs more than 15 minutes, up to a maximum of 3600.",
  ...
  retrievalCandidates: "Raise 50 to 100 to consider more matches. Searches take more work but may find harder evidence.",
  retrievalVariantConcurrency: "Raise 2 to 4 to search more question versions in parallel. The database will do more concurrent work.",
  queryExpansions: "Raise 2 to 3 to search one more AI-written variation for every question.",
  queryExpansionTemperature: "Keep this at 0 for the most reproducible expansions, or raise it to allow more sampling variation.",
  answerTemperature: "Keep this at 0 for the most reproducible grounded answers, or raise it to allow more sampling variation.",
  generationSeedMode: "Choose Stable to derive repeatable seeds from the question and resolved scope, or Random to let the provider choose.",
  denseWeight: "Raise 1 to 2 to make semantic matches count twice as much in fusion.",
  lexicalWeight: "Raise 1 to 2 to make keyword matches count twice as much in fusion.",
  originalQueryWeight: "Raise 1 to 2 to favor results found with the user's exact wording.",
  expansionQueryWeight: "Lower 1 to 0.5 to give AI-written searches less influence than the original question.",
  expansionDecay: "Set 0.5 so each later AI-written search has half the weight of the previous one.",
  rrfK: "Raise 60 to 100 to make small rank differences matter less.",
  topK: "Raise 10 to 15 to give the answer model more context. Prompts will be larger.",
