...
export const runtimeSettingDefinitions: readonly RuntimeSettingDefinition[] = [
  ...
  setting("publicOrigins", "Web server", "Public origins", "json", "The browser origins that can use CiteLoom. The first origin is used for OAuth and MCP URLs. Restart the web service after saving this value."),
...
export const runtimeSettingChangeExamples = {
  ...
  publicOrigins: "Add each browser origin as a JSON string. Put the OAuth and MCP origin first, then restart the web service.",
